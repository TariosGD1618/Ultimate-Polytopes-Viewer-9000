  ...
  if(dimentionCount==4&&inp2.value()==4) {
    ...
    switch(polytopeID) {
      ...
      case 55:
        ...
        circumR=sqrt(2)
        //edgeLength=1
        intersectionD=dist(vertexData[0][0],vertexData[0][1],vertexData[0][2],vertexData[31][0],vertexData[31][1],vertexData[31][2])
        //intData=[[0,1]]
        L=24*7
        L2=24*2
        ...
        intData=[[0,20],[0,23],[0,28],[0,31],[1,20],[1,23],[1,28],[1,31],[2,24],[2,25],[2,26],[2,27],[3,24],[3,25],[3,26],[3,27],[4,21],[4,22],[4,29],[4,30],[5,21],[5,22],[5,29],[5,30]]
...
function renderLine(a1,a2,Q) {
  ...
  if(simpleM>0) {
    ...
    incr = max(2*PI/floor(200/L),PI/8)
